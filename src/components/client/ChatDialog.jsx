                ...
                <ScrollArea className="flex-1 pr-4 overflow-y-auto">
                    <div className="space-y-4 min-w-0">
                        {messages.map((msg, index) => (
                            <div
                                key={index}
                                className={`flex items-start gap-3 min-w-0 ${msg.role === "user" ? "flex-row-reverse" : ""
                                    }`}
                            >
                                <div
                                    className={`p-2 rounded-full ${msg.role === "user"
                                ...
                                <div
                                    className={`p-3 rounded-lg max-w-[80%] min-w-0 text-sm break-words overflow-wrap-anywhere hyphens-auto ${msg.role === "user"
                                        ? "bg-primary text-primary-foreground"
                                        : "bg-muted"
                                        }`}
